...
event1 = Event.create!(:contestant_id => cont12.id, :schema_id => survival1.id, :episode_id => episode1.id)
event2 = Event.create!(:contestant_id => cont10.id, :schema_id => survival1.id, :episode_id => episode1.id)
event3 = Event.create!(:contestant_id => cont9.id, :schema_id => survival1.id, :episode_id => episode1.id)
event4 = Event.create!(:contestant_id => cont14.id, :schema_id => survival1.id, :episode_id => episode1.id)
event5 = Event.create!(:contestant_id => cont16.id, :schema_id => survival1.id, :episode_id => episode1.id)
event6 = Event.create!(:contestant_id => cont25.id, :schema_id => survival1.id, :episode_id => episode1.id)
event7 = Event.create!(:contestant_id => cont7.id, :schema_id => survival1.id, :episode_id => episode1.id)
event8 = Event.create!(:contestant_id => cont17.id, :schema_id => survival1.id, :episode_id => episode1.id)
event9 = Event.create!(:contestant_id => cont19.id, :schema_id => survival1.id, :episode_id => episode1.id)
event10 = Event.create!(:contestant_id => cont24.id, :schema_id => survival1.id, :episode_id => episode1.id)
event11 = Event.create!(:contestant_id => cont23.id, :schema_id => survival1.id, :episode_id => episode1.id)
event12 = Event.create!(:contestant_id => cont15.id, :schema_id => survival1.id, :episode_id => episode1.id)
event13 = Event.create!(:contestant_id => cont18.id, :schema_id => survival1.id, :episode_id => episode1.id)
event14 = Event.create!(:contestant_id => cont11.id, :schema_id => survival1.id, :episode_id => episode1.id)
event15 = Event.create!(:contestant_id => cont22.id, :schema_id => survival1.id, :episode_id => episode1.id)
event16 = Event.create!(:contestant_id => cont20.id, :schema_id => survival1.id, :episode_id => episode1.id)
event17 = Event.create!(:contestant_id => cont13.id, :schema_id => survival1.id, :episode_id => episode1.id)
event18 = Event.create!(:contestant_id => cont21.id, :schema_id => survival1.id, :episode_id => episode1.id)
event19 = Event.create!(:contestant_id => cont8.id, :schema_id => survival1.id, :episode_id => episode1.id)
event20 = Event.create!(:contestant_id => cont15.id, :schema_id => survival2.id, :episode_id => episode2.id)
event21 = Event.create!(:contestant_id => cont22.id, :schema_id => survival2.id, :episode_id => episode2.id)
event22 = Event.create!(:contestant_id => cont10.id, :schema_id => survival2.id, :episode_id => episode2.id)
event23 = Event.create!(:contestant_id => cont9.id, :schema_id => survival2.id, :episode_id => episode2.id)
event24 = Event.create!(:contestant_id => cont8.id, :schema_id => survival2.id, :episode_id => episode2.id)
event25 = Event.create!(:contestant_id => cont16.id, :schema_id => survival2.id, :episode_id => episode2.id)
event26 = Event.create!(:contestant_id => cont17.id, :schema_id => survival2.id, :episode_id => episode2.id)
event27 = Event.create!(:contestant_id => cont11.id, :schema_id => survival2.id, :episode_id => episode2.id)
event28 = Event.create!(:contestant_id => cont14.id, :schema_id => survival2.id, :episode_id => episode2.id)
event29 = Event.create!(:contestant_id => cont7.id, :schema_id => survival2.id, :episode_id => episode2.id)
event30 = Event.create!(:contestant_id => cont20.id, :schema_id => survival2.id, :episode_id => episode2.id)
event31 = Event.create!(:contestant_id => cont19.id, :schema_id => survival2.id, :episode_id => episode2.id)
event32 = Event.create!(:contestant_id => cont12.id, :schema_id => survival2.id, :episode_id => episode2.id)
event33 = Event.create!(:contestant_id => cont21.id, :schema_id => survival2.id, :episode_id => episode2.id)
event34 = Event.create!(:contestant_id => cont13.id, :schema_id => survival2.id, :episode_id => episode2.id)
event35 = Event.create!(:contestant_id => cont18.id, :schema_id => survival2.id, :episode_id => episode2.id)
event36 = Event.create!(:contestant_id => cont23.id, :schema_id => survival38.id, :episode_id => episode2.id)
event37 = Event.create!(:contestant_id => cont24.id, :schema_id => survival38.id, :episode_id => episode2.id)
event38 = Event.create!(:contestant_id => cont25.id, :schema_id => survival12.id, :episode_id => episode2.id)
event39 = Event.create!(:contestant_id => cont11.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont8.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont9.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont12.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont19.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont7.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont13.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont16.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont14.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont15.id, :schema_id => survival3.id, :episode_id => episode3.id)
event40 = Event.create!(:contestant_id => cont17.id, :schema_id => survival3.id, :episode_id => episode3.id)
event50 = Event.create!(:contestant_id => cont18.id, :schema_id => survival3.id, :episode_id => episode3.id)
event51 = Event.create!(:contestant_id => cont10.id, :schema_id => survival3.id, :episode_id => episode3.id)
event51 = Event.create!(:contestant_id => cont10.id, :schema_id => survival3.id, :episode_id => episode3.id)
event52 = Event.create!(:contestant_id => cont20.id, :schema_id => survival38.id, :episode_id => episode3.id)
event53 = Event.create!(:contestant_id => cont21.id, :schema_id => survival38.id, :episode_id => episode3.id)
event54 = Event.create!(:contestant_id => cont22.id, :schema_id => survival38.id, :episode_id => episode3.id)
event55 = Event.create!(:contestant_id => cont14.id, :schema_id => survival4.id, :episode_id => episode4.id)
event56 = Event.create!(:contestant_id => cont12.id, :schema_id => survival4.id, :episode_id => episode4.id)
event57 = Event.create!(:contestant_id => cont7.id, :schema_id => survival4.id, :episode_id => episode4.id)
event58 = Event.create!(:contestant_id => cont10.id, :schema_id => survival4.id, :episode_id => episode4.id)
event59 = Event.create!(:contestant_id => cont8.id, :schema_id => survival4.id, :episode_id => episode4.id)
event60 = Event.create!(:contestant_id => cont11.id, :schema_id => survival4.id, :episode_id => episode4.id)
event61 = Event.create!(:contestant_id => cont16.id, :schema_id => survival4.id, :episode_id => episode4.id)
event62 = Event.create!(:contestant_id => cont9.id, :schema_id => survival4.id, :episode_id => episode4.id)
event63 = Event.create!(:contestant_id => cont15.id, :schema_id => survival4.id, :episode_id => episode4.id)
event64 = Event.create!(:contestant_id => cont17.id, :schema_id => survival4.id, :episode_id => episode4.id)
event65 = Event.create!(:contestant_id => cont13.id, :schema_id => survival4.id, :episode_id => episode4.id)
event66 = Event.create!(:contestant_id => cont18.id, :schema_id => survival38.id, :episode_id => episode4.id)
event67 = Event.create!(:contestant_id => cont19.id, :schema_id => survival38.id, :episode_id => episode4.id)
event68 = Event.create!(:contestant_id => cont8.id, :schema_id => survival5.id, :episode_id => episode5.id)
event69 = Event.create!(:contestant_id => cont13.id, :schema_id => survival5.id, :episode_id => episode5.id)
event70 = Event.create!(:contestant_id => cont12.id, :schema_id => survival5.id, :episode_id => episode5.id)
event71 = Event.create!(:contestant_id => cont14.id, :schema_id => survival5.id, :episode_id => episode5.id)
event72 = Event.create!(:contestant_id => cont7.id, :schema_id => survival5.id, :episode_id => episode5.id)
event73 = Event.create!(:contestant_id => cont11.id, :schema_id => survival5.id, :episode_id => episode5.id)
event74 = Event.create!(:contestant_id => cont9.id, :schema_id => survival5.id, :episode_id => episode5.id)
event75 = Event.create!(:contestant_id => cont15.id, :schema_id => survival5.id, :episode_id => episode5.id)
event76 = Event.create!(:contestant_id => cont10.id, :schema_id => survival5.id, :episode_id => episode5.id)
event77 = Event.create!(:contestant_id => cont16.id, :schema_id => survival38.id, :episode_id => episode5.id)
event78 = Event.create!(:contestant_id => cont17.id, :schema_id => survival38.id, :episode_id => episode5.id)
event79 = Event.create!(:contestant_id => cont7.id, :schema_id => survival6.id, :episode_id => episode6.id)
event80 = Event.create!(:contestant_id => cont11.id, :schema_id => survival6.id, :episode_id => episode6.id)
event81 = Event.create!(:contestant_id => cont10.id, :schema_id => survival6.id, :episode_id => episode6.id)
event82 = Event.create!(:contestant_id => cont8.id, :schema_id => survival6.id, :episode_id => episode6.id)
event83 = Event.create!(:contestant_id => cont9.id, :schema_id => survival6.id, :episode_id => episode6.id)
event84 = Event.create!(:contestant_id => cont12.id, :schema_id => survival6.id, :episode_id => episode6.id)
event85 = Event.create!(:contestant_id => cont13.id, :schema_id => survival38.id, :episode_id => episode6.id)
event86 = Event.create!(:contestant_id => cont14.id, :schema_id => survival38.id, :episode_id => episode6.id)
event87 = Event.create!(:contestant_id => cont15.id, :schema_id => survival38.id, :episode_id => episode6.id)
event88 = Event.create!(:contestant_id => cont8.id, :schema_id => survival7.id, :episode_id => episode7.id)
event89 = Event.create!(:contestant_id => cont10.id, :schema_id => survival7.id, :episode_id => episode7.id)
event90 = Event.create!(:contestant_id => cont7.id, :schema_id => survival7.id, :episode_id => episode7.id)
event91 = Event.create!(:contestant_id => cont9.id, :schema_id => survival7.id, :episode_id => episode7.id)
event92 = Event.create!(:contestant_id => cont11.id, :schema_id => survival7.id, :episode_id => episode7.id)
event93 = Event.create!(:contestant_id => cont12.id, :schema_id => survival38.id, :episode_id => episode7.id)
event94 = Event.create!(:contestant_id => cont9.id, :schema_id => survival8.id, :episode_id => episode8.id)
event95 = Event.create!(:contestant_id => cont8.id, :schema_id => survival8.id, :episode_id => episode8.id)
event96 = Event.create!(:contestant_id => cont7.id, :schema_id => survival8.id, :episode_id => episode8.id)
event97 = Event.create!(:contestant_id => cont10.id, :schema_id => survival38.id, :episode_id => episode8.id)
event98 = Event.create!(:contestant_id => cont8.id, :schema_id => survival9.id, :episode_id => episode9.id)
event99 = Event.create!(:contestant_id => cont7.id, :schema_id => survival9.id, :episode_id => episode9.id)
event100 = Event.create!(:contestant_id => cont9.id, :schema_id => survival38.id, :episode_id => episode9.id)
event101 = Event.create!(:contestant_id => cont7.id, :schema_id => survival10.id, :episode_id => episode10.id)
event102 = Event.create!(:contestant_id => cont8.id, :schema_id => survival38.id, :episode_id => episode10.id)