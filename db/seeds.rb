...
season2 = Season.create(:name => 'The Bachelorette: Desiree', :number => 12, :premiere_date => two_weeks, :finale_date => two_weeks - 45, :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat perspiciatis sequi culpa tempora et reprehenderit dolores, amet quos fugit numquam veritatis cupiditate fuga possimus ab sit alias, sunt, vitae. Iure.', :show_id => show2.id, :episode_count => 10)
season3 = Season.create(:name => 'The Bachelor: Sean Lowe', :number => 17, :premiere_date => '01/07/2013', :finale_date => '01/12/2013', :description	=> 'The best bachelor ever - Sean Lowe is the man!', :image => '/assets/the_bachelor/logo.jpg', :episode_count => 10, :show_id => show1.id, :expired => true)
