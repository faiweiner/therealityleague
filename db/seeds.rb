...
score1 = Score.create(:round_id => round1.id, :contestant_id => cont7.id, :event => 'hot tub', :points => 50)
score2 = Score.create(:round_id => round1.id, :contestant_id => cont8.id, :event => 'group date', :points => 25)
score3 = Score.create(:round_id => round2.id, :contestant_id => cont17.id, :event => 'one-on-one date', :points => 75)
score4 = Score.create(:round_id => round2.id, :contestant_id => cont25.id, :event => 'cried', :points => 25)
score5 = Score.create(:round_id => round3.id, :contestant_id => cont20.id, :event => 'confrontation', :points => 25)
score6 = Score.create(:round_id => round3.id, :contestant_id => cont13.id, :event => 'intoxication', :points => 15)

score7 = Score.create(:round_id => round4.id, :contestant_id => cont8.id, :event => 'intoxication', :points => 15)
score8 = Score.create(:round_id => round4.id, :contestant_id => cont7.id, :event => 'intoxication', :points => 50)
score9 = Score.create(:round_id => round5.id, :contestant_id => cont9.id, :event => 'intoxication', :points => 10)
score10 = Score.create(:round_id => round5.id, :contestant_id => cont13.id, :event => 'intoxication', :points => 15)
score11 = Score.create(:round_id => round6.id, :contestant_id => cont9.id, :event => 'intoxication', :points => 25)
score12 = Score.create(:round_id => round6.id, :contestant_id => cont10.id, :event => 'intoxication', :points => 15)
score13 = Score.create(:round_id => round7.id, :contestant_id => cont11.id, :event => 'intoxication', :points => 45)
score14 = Score.create(:round_id => round7.id, :contestant_id => cont20.id, :event => 'intoxication', :points => 10)
score15 = Score.create(:round_id => round8.id, :contestant_id => cont13.id, :event => 'intoxication', :points => 15)
score16 = Score.create(:round_id => round8.id, :contestant_id => cont8.id, :event => 'intoxication', :points => 10)
score17 = Score.create(:round_id => round9.id, :contestant_id => cont11.id, :event => 'one-on-one date', :points => 50)
score18 = Score.create(:round_id => round9.id, :contestant_id => cont10.id, :event => 'intoxication', :points => 50)
score19 = Score.create(:round_id => round10.id, :contestant_id => cont25.id, :event => 'fantasy suite', :points => 75)
score20 = Score.create(:round_id => round10.id, :contestant_id => cont7.id, :event => 'fantasy suite', :points => 75)