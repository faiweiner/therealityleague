...
show1 = Show.create(:name => 'The Bachelor', :premiere_date => two_weeks, :draft_close_date => two_weeks - 5, :description => 'With his Spanish accent, good looks, salsa moves and undying devotion for his daughter, Juan Pablo, 32, was a fan favorite. Sadly, Desiree Hartsock couldn\'t see a future with Juan Pablo and sent him home from Barcelona.', :image => '/assets/the_bachelor/logo.jpg')
show2 = Show.create(:name => 'The Bachelorette', :premiere_date => two_weeks, :draft_close_date => two_weeks - 5, :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat perspiciatis sequi culpa tempora et reprehenderit dolores, amet quos fugit numquam veritatis cupiditate fuga possimus ab sit alias, sunt, vitae. Iure.', :image => '/assets/the_bachelorette/logo.png')
show3 = Show.create(:name => 'The Challenge', :premiere_date => three_weeks, :draft_close_date => three_weeks - 5, :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione voluptatum similique nihil quo excepturi eveniet modi. Fuga quaerat dolorum quidem itaque autem corporis, ratione eligendi, fugiat at sunt qui alias.', :image => '/assets/the_challenge/rivals_logo.jpg')
show4 = Show.create(:name => 'The Voice', :premiere_date => one_month, :draft_close_date => one_month - 5, :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. A ipsam illum eos accusantium ad doloribus porro, pariatur sed. Libero magni debitis culpa natus, illum ex ut facilis vel qui. Voluptatibus.', :image => '/assets/the_voice/logo.jpg')
show5 = Show.create(:name => 'The Bachelor Pad', :premiere_date => one_week, :draft_close_date => one_week - 5, :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Harum laudantium iure, iusto doloremque odit delectus tempora molestiae eos soluta, voluptatum expedita ipsum ut quod eius non minus placeat vel! Sit.', :image => '/assets/bachelor_pad/logo.jpg')
show6 = Show.create(:name => 'Master Chef', :premiere_date => last_month, :draft_close_date => last_month - 5, :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores animi id repudiandae alias expedita, nisi aspernatur vel natus quam, recusandae sint assumenda mollitia qui culpa at delectus harum explicabo totam!', :image => '/assets/master_chef/logo.png')
