...
show1 = Show.create(:name => 'The Bachelor', :premiere_date => two_weeks, :draft_close_date => two_weeks - 5, :description => 'With his Spanish accent, good looks, salsa moves and undying devotion for his daughter, Juan Pablo, 32, was a fan favorite. Sadly, Desiree Hartsock couldn\'t see a future with Juan Pablo and sent him home from Barcelona.', :image => '/assets/the_bachelor/logo.jpg', :episode_count => 10)
