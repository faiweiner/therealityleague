...
cont7 = Contestant.create(:name => 'Catherine', :season_id => season3.id, :age => 26, :gender => 'Female', :occupation => 'Graphic Designer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/catherine.jpg')
cont8 = Contestant.create(:name => 'Lindsay', :season_id => season3.id, :age => 24, :gender => 'Female', :occupation => 'Substitute Teacher', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/lindsay.jpg')
cont9 = Contestant.create(:name => 'AshLee', :season_id => season3.id, :age => 32, :gender => 'Female', :occupation => 'Personal Organizer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/ashlee.jpg')
cont10 = Contestant.create(:name => 'Desiree', :season_id => season3.id, :age => 26, :gender => 'Female', :occupation => 'Bridal Stylist', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/desiree.jpg')
cont11 = Contestant.create(:name => 'Lesley M.', :season_id => season3.id, :age => 24, :gender => 'Female', :occupation => 'Political Consultant', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/lesley.jpg')
cont12 = Contestant.create(:name => 'Tierra', :season_id => season3.id, :age => 24, :gender => 'Female', :occupation => 'Leasing Consultant', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/tierra.jpg')
cont13 = Contestant.create(:name => 'Daniella', :season_id => season3.id, :age => 24, :gender => 'Female', :occupation => 'Commercial Casting Associate', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/daniella.jpg')
cont14 = Contestant.create(:name => 'Selma', :season_id => season3.id, :age => 29, :gender => 'Female', :occupation => 'Real Estate Dealer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/selma.jpg')
cont15 = Contestant.create(:name => 'Sarah', :season_id => season3.id, :age => 26, :gender => 'Female', :occupation => 'Advertising Executive', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/sarah.jpg')
cont16 = Contestant.create(:name => 'Robyn', :season_id => season3.id, :age => 24, :gender => 'Female', :occupation => 'Oil Field Account Manager', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/.jpg')
cont17 = Contestant.create(:name => 'Jackie', :season_id => season3.id, :age => 25, :gender => 'Female', :occupation => 'Cosmetics Consultant', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/robyn.jpg')
cont18 = Contestant.create(:name => 'Amanda', :season_id => season3.id, :age => 28, :gender => 'Female', :occupation => 'Fit Model', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/amanda.jpg')
cont19 = Contestant.create(:name => 'Leslie H.', :season_id => season3.id, :age => 26, :gender => 'Female', :occupation => 'Poker Dealer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/leslie.jpg')
cont20 = Contestant.create(:name => 'Kristy', :season_id => season3.id, :age => 26, :gender => 'Female', :occupation => 'Model', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/kristy.jpg')
cont21 = Contestant.create(:name => 'Taryn', :season_id => season3.id, :age => 30, :gender => 'Female', :occupation => 'Health Club Manager', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/taryn.jpg')
cont22 = Contestant.create(:name => 'Kacie', :season_id => season3.id, :age => 25, :gender => 'Female', :occupation => 'Community Organizer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/kacie.jpg')
cont23 = Contestant.create(:name => 'Brooke', :season_id => season3.id, :age => 25, :gender => 'Female', :occupation => 'Graphic Designer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/brooke.jpg')
cont24 = Contestant.create(:name => 'Diana', :season_id => season3.id, :age => 31, :gender => 'Female', :occupation => 'Salon Owner', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/diana.jpg')
cont25 = Contestant.create(:name => 'Katie', :season_id => season3.id, :age => 27, :gender => 'Female', :occupation => 'Yoga Instructor', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/season18/katie.jpg')
