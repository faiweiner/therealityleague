...
cont7 = Contestant.create(:name => 'Catherine', :show_id => show3.id, :age => 26, :gender => 'Female', :occupation => 'Graphic Designer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont8 = Contestant.create(:name => 'Lindsay', :show_id => show3.id, :age => 24, :gender => 'Female', :occupation => 'Substitute Teacher', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont9 = Contestant.create(:name => 'AshLee', :show_id => show3.id, :age => 32, :gender => 'Female', :occupation => 'Personal Organizer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont10 = Contestant.create(:name => 'Desiree', :show_id => show3.id, :age => 26, :gender => 'Female', :occupation => 'Bridal Stylist', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont11 = Contestant.create(:name => 'Lesley M.', :show_id => show3.id, :age => 24, :gender => 'Female', :occupation => 'Political Consultant', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont12 = Contestant.create(:name => 'Tierra', :show_id => show3.id, :age => 24, :gender => 'Female', :occupation => 'Leasing Consultant', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont13 = Contestant.create(:name => 'Daniella', :show_id => show3.id, :age => 24, :gender => 'Female', :occupation => 'Commercial Casting Associate', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont14 = Contestant.create(:name => 'Selma', :show_id => show3.id, :age => 29, :gender => 'Female', :occupation => 'Real Estate Dealer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont15 = Contestant.create(:name => 'Sarah', :show_id => show3.id, :age => 26, :gender => 'Female', :occupation => 'Advertising Executive', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont16 = Contestant.create(:name => 'Robyn', :show_id => show3.id, :age => 24, :gender => 'Female', :occupation => 'Oil Field Account Manager', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont17 = Contestant.create(:name => 'Jackie', :show_id => show3.id, :age => 25, :gender => 'Female', :occupation => 'Cosmetics Consultant', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont18 = Contestant.create(:name => 'Amanda', :show_id => show3.id, :age => 28, :gender => 'Female', :occupation => 'Fit Model', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont19 = Contestant.create(:name => 'Leslie H.', :show_id => show3.id, :age => 26, :gender => 'Female', :occupation => 'Poker Dealer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont20 = Contestant.create(:name => 'Kristy', :show_id => show3.id, :age => 26, :gender => 'Female', :occupation => 'Model', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont21 = Contestant.create(:name => 'Taryn', :show_id => show3.id, :age => 30, :gender => 'Female', :occupation => 'Health Club Manager', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont22 = Contestant.create(:name => 'Kacie', :show_id => show3.id, :age => 25, :gender => 'Female', :occupation => 'Community Organizer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont23 = Contestant.create(:name => 'Brooke', :show_id => show3.id, :age => 25, :gender => 'Female', :occupation => 'Graphic Designer', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont24 = Contestant.create(:name => 'Diana', :show_id => show3.id, :age => 31, :gender => 'Female', :occupation => 'Salon Owner', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
cont25 = Contestant.create(:name => 'Katie', :show_id => show3.id, :age => 27, :gender => 'Female', :occupation => 'Yoga Instructor', :description => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit!', :image => '/assets/woman_placeholder.png')
